...
#include "DetectorAPConstruction.h"
...
G4ThreadLocal
G4GlobalMagFieldMessenger* DetectorAPConstruction::m_magFieldMessenger = 0;


DetectorAPConstruction::DetectorAPConstruction(std::string name)
 : 
  IMsgService(name), 
...
DetectorAPConstruction::~DetectorAPConstruction()
{;}


G4VPhysicalVolume* DetectorAPConstruction::Construct()
{
  // Define materials
  DefineMaterials();
  // Define volumes
...
void DetectorAPConstruction::DefineMaterials()
{
...
G4VPhysicalVolume* DetectorAPConstruction::DefineVolumes()
{
...
void DetectorAPConstruction::ConstructSDandField()
{
...
void DetectorAPConstruction::CreateBarrel(  G4LogicalVolume *worldLV,
                                          std::string name,  
...

{
  if ( ! defaultMaterial || ! absorberMaterial || ! gapMaterial ) {
    ...
    G4Exception("DetectorAPConstruction::DefineVolumes()", "MyCode0001", FatalException, msg);
  }
